...
## Overview
Use `protonemedia/laravel-paddle.` in a Laravel application.
...
- Activate when code references `protonemedia/laravel-paddle.` classes, facades, config, or documented features.
